...
import './feature-card29.css'

const FeatureCard29 = (props) => {
  return (
    <div className={`feature-card29-feature-card ${props.rootClassName} `}>
      <svg viewBox="0 0 1024 1024" className="feature-card29-icon">
        <path
      ...
      <div className="feature-card29-container">
        <h2 className="feature-card29-text">{props.title}</h2>
