...
import './feature-card210.css'

const FeatureCard210 = (props) => {
  return (
    <div className={`feature-card210-feature-card ${props.rootClassName} `}>
      <svg viewBox="0 0 1024 1024" className="feature-card210-icon">
        <path
      ...
      <div className="feature-card210-container">
        <h2 className="feature-card210-text">{props.title}</h2>
...
FeatureCard210.propTypes = {
  rootClassName: PropTypes.string,
  description: PropTypes.string,
  title: PropTypes.string,
}

export default FeatureCard210
