...
import './feature-card214.css'

const FeatureCard214 = (props) => {
  return (
    <div className={`feature-card214-feature-card ${props.rootClassName} `}>
      <svg viewBox="0 0 1024 1024" className="feature-card214-icon">
        <path
      ...
      <div className="feature-card214-container">
        <h2 className="feature-card214-text">{props.title}</h2>
...
FeatureCard214.propTypes = {
  title: PropTypes.string,
  rootClassName: PropTypes.string,
  description: PropTypes.string,
}

export default FeatureCard214
