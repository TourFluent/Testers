...
import './feature-card213.css'

const FeatureCard213 = (props) => {
  return (
    <div className={`feature-card213-feature-card ${props.rootClassName} `}>
      <svg viewBox="0 0 1024 1024" className="feature-card213-icon">
        <path
      ...
      <div className="feature-card213-container">
        <h2 className="feature-card213-text">{props.title}</h2>
...
FeatureCard213.propTypes = {
  description: PropTypes.string,
  title: PropTypes.string,
  rootClassName: PropTypes.string,
}

export default FeatureCard213
